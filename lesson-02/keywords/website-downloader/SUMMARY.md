# Website Downloader — Keyword Research Summary
...
### Main Keyword: "website downloader"

| Criterion | Score | Max | Notes |
|-----------|-------|-----|-------|
| Volume (2,400 US) | 8 | 10 | Good volume |
| KD (59%) | 5 | 10 | Difficult zone |
| Intent (Informational) | 4 | 10 | Not transactional |
| CPC ($1.38) | 5 | 10 | Low commercial value |
| Competition | 3 | 10 | 20+ competitors in CWS |
| **TOTAL** | **25** | **50** | Below threshold (30+) |

### Best Keyword: "website copier"

| Criterion | Score | Max | Notes |
|-----------|-------|-----|-------|
| Volume (880 US) | 6 | 10 | Decent volume |
| KD (46%) | 6 | 10 | Possible zone |
| Intent (I+T) | 8 | 10 | **Transactional present!** |
| CPC ($8.01) | 9 | 10 | **Strong commercial value!** |
...
### From MongoDB (20 extensions found)

| Competitor | Score | Status |
|------------|-------|--------|
| Website Downloader | 0.697 | Direct competitor |
| XDown | 0.695 | General downloader |
| Web Page Downloader | 0.674 | Direct competitor |
| All Links Downloader | 0.656 | Batch downloads |
| Gopeed | 0.628 | Browser extension |

### From SERP Analysis ("html downloader")

| Position | Domain | Type |
|----------|--------|------|
| 1 | chromewebstore.google.com | Extension |
| 2 | saveweb2zip.com | Web Tool |
| 3 | httrack.com | Software (69K backlinks) |
| 4 | reddit.com | Discussion |
| 5 | waybackmachinedownloader.com | Web Tool |
