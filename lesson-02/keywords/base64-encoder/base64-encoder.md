...
|--------|-------|------------|
| Volume US | 880 | MODERATE |
| KD% | 28% | EASY |
| Global EN | 8,800 | Estimated (US × 10) |
| All Languages | 88,000 | Estimated (Global × 10) |
...
|----------|---------------|
| 5% capture rate | 4,400 |
| 10% capture rate | 8,800 |
...
Low KD and sufficient volume. Good opportunity if softness confirms.
