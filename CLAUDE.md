...
### Шаг 5: Создание Issue (опционально)

Для отслеживания прогресса можно создать GitHub Issue:

```markdown
## Issue Template

**Название:** Week 1: [Текущий урок] - [Статус]

**Описание:**
- Текущий прогресс: [X/4 уроков]
- Блокеры: [список]
- Следующие шаги: [список]

**Labels:** week-1, [lesson-XX], [status]
```
